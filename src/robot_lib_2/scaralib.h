...
//由变位机旋转角度以及变位机坐标系的点矩阵，获取该点在系统坐标系下的位姿矩阵
Matrix4d cHPos2SysPosAtt(Coint c, Matrix4d ch_m);
//由变位机旋转角度以及系统坐标系下的位姿矩阵,获取该点在变位机坐标系下的坐标矩阵
Matrix4d sysPosAtt2CHPos(Coint c, Matrix4d sys_m);
